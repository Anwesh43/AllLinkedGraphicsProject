package com.example.horizcrossvertlineview
...
fun Canvas.drawHorizCrossVertLine(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawHCVLNode(i : Int, scale : Float, paint : Paint) {
...
class HorizCrossVertLineView(ctx : Context) : View(ctx) {
    ...
    data class HorizCrossVertLine(var i : Int) {

        private var curr : HCVLNode = HCVLNode(0)
