package com.example.linesquarediveview
...
fun Canvas.drawLineSquarDive(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLSDNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineSquarDive(scale, w, h, paint)
}

class LineSquareDiveView(ctx : Context) : View(ctx) {
    ...
    data class LSDNode(var i : Int, val state : State = State()) {
        ...
        fun draw(canvas : Canvas, paint : Paint) {
            canvas.drawLSDNode(i, state.scale, paint)
        }
    ...
    data class LineSquareDive(var i : Int) {
