package com.example.linetakenbylinesview
...
fun Canvas.drawLineTakenByLines(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLTBLNode(i : Int, scale : Float, paint : Paint) {
    val w : Float = width.toFloat()
    val h : Float = height.toFloat()
    paint.color = colors[i]
    paint.strokeCap = Paint.Cap.ROUND
    paint.strokeWidth = Math.min(w, h) / strokeFactor
    drawLineTakenByLines(scale, w, h, paint)
}

class LineTakenByLinesView(ctx : Context) : View(ctx) {
