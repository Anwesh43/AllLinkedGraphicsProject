package com.example.squareshooterballview
...
fun Canvas.drawSquareShooterBall(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawSSBNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawSquareShooterBall(scale, w, h, paint)
}

class SquareShooterBallView(ctx : Context) : View(ctx) {
    ...
    data class SquareShooterBall(var i : Int, val state : State = State()) {
