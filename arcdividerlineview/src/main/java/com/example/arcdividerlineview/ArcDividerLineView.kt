package com.example.arcdividerlineview
...
fun Canvas.drawArcDividerLine(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawADLNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawArcDividerLine(scale, w, h, paint)
}

class ArcDividerLineView(ctx : Context) : View(ctx) {
    ...
    data class ArcDividerLine(var i : Int) {

        private var curr : ADLNode = ADLNode(0)
    ...
    data class Renderer(var view : ArcDividerLineView) {

        private val animator : Animator = Animator(view)
        private val adl : ArcDividerLine = ArcDividerLine(0)
