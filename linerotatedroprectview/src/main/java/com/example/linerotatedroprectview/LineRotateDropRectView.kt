...
class LineRotateDropRectView(ctx : Context) : View(ctx) {
    ...
    data class LRDRNode(var i : Int, val state : State = State()) {
    ...
    data class LineRotateDropRect(var i : Int) {
    ...
    data class Renderer(var view : LineRotateDropRectView) {

        private val animator : Animator = Animator(view)
        private val lrdr : LineRotateDropRect = LineRotateDropRect(0)
