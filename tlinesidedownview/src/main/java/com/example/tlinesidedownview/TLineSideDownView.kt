package com.example.tlinesidedownview
...
fun Canvas.drawTLineSideDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawTLSDNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawTLineSideDown(scale, w, h, paint)
}

class TLineSideDownView(ctx : Context) : View(ctx) {
    ...
    data class TLineSideDown(var i : Int) {
