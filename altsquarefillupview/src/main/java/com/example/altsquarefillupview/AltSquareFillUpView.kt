...
fun Canvas.drawAltSquareFillUp(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawASFUNode(i  : Int, scale : Float, paint : Paint) {
...
class AltSquareFillUpView(ctx : Context) : View(ctx) {
    ...
    data class ASFUNode(var i : Int, val state : State = State()) {

        private var next : ASFUNode? = null
        ...
        fun draw(canvas : Canvas, paint : Paint) {
            canvas.drawASFUNode(i, state.scale, paint)
        }
