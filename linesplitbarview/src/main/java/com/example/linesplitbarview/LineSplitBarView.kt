package com.example.linesplitbarview
...
fun Canvas.drawLineSplitBar(scale : Float, w : Float, h : Float, paint : Paint) {
    ...
    save()
    translate(-size / 2 - w / 2 + (w / 2 + size / 2) * sc2, 0f)
...
fun Canvas.drawLSBNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineSplitBar(scale, w, h, paint)
}
...
class LineSplitBarView(ctx : Context) : View(ctx) {
    ...
    data class LineSplitBar(var i : Int) {

        private var curr : LSBNode = LSBNode(i + 1)
    ...
    data class Renderer(var view : LineSplitBarView) {

        private val animator : Animator = Animator(view)
        private val lsb : LineSplitBar = LineSplitBar(0)
